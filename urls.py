...
urlpatterns = patterns('',
    ...
    (r'^viewer/(?P<dataset_id>\d+)/explore/delete_nodes/(?P<node_list>[-\w,]+)$', 
            'plexigraph.graphview.views.delete_nodes'),
    (r'^viewer/(?P<dataset_id>\d+)/explore/delete_edges/(?P<edge_list>[-\w,]+)$', 
            'plexigraph.graphview.views.delete_edges'),
    (r'^viewer/(?P<dataset_id>\d+)/explore/expand_nodes/(?P<node_list>[-\w,]+)$', 
